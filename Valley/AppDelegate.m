...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	VAMainViewController *mainViewController = [[VAMainViewController alloc] init];
...
//	[[SDWebImageDownloader sharedDownloader] setShouldDecompressImages:NO];
    ...
    [[[SDWebImageManager sharedManager] imageDownloader] setShouldDecompressImages:NO];
	
	[[SDWebImageManager sharedManager] imageCache].maxCacheSize = 10*1024;
    [[SDWebImageManager sharedManager] imageCache].maxMemoryCost = 200;
